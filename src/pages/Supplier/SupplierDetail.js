...
export default function SupplierDetail({navigation, route}) {
  ...
  return (
    <SafeAreaView
      ...
      <View
        ...
        <MyList label="Telepon supplier" value={ITEM.telepon_supplier} />
        <MyList label="Alamat supplier" value={ITEM.alamat_supplier} />
      </View>
      <View
        style={{
          flexDirection: 'row',
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('SupplierEdit', ITEM)}
          style={{
            flexDirection: 'row',
