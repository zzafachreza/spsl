  ...
  return (
    <SafeAreaView
      ...
      <View
        ...
        <MyList label="Nama barang" value={ITEM.nama_barang} />
        <MyList
          label="Harga Beli"
          value={new Intl.NumberFormat().format(ITEM.harga_beli)}
        />
        <MyList
          label="Harga Jual"
          value={new Intl.NumberFormat().format(ITEM.harga_jual)}
        />
      ...
      <View
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('BarangEdit', ITEM)}
          style={{
            flexDirection: 'row',
